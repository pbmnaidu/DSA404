...
export function getSocialIcon(platform: string, className = "size-4") {
  ...
  if (norm.includes("linkedin")) return <LinkedInIcon className={className} />;
  if (norm.includes("github")) return <GitHubIcon className={className} />;
  if (norm.includes("twitter") || norm === "x") return <TwitterIcon className={className} />;
  if (norm.includes("youtube")) return <YouTubeIcon className={className} />;
  if (norm.includes("instagram")) return <InstagramIcon className={className} />;
  if (norm.includes("discord")) return <DiscordIcon className={className} />;
  if (norm.includes("portfolio") || norm.includes("website") || norm.includes("web")) return <Globe className={className} />;
